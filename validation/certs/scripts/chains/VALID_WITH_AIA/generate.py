...
def simple_ocsp_aia(asn):
    return x509.authority_information_access([("http://localhost",
                                               "id-ad-ocsp")], asn)
...
def main():
    ...
    # Create a basic CRLDP extension
    aia = simple_ocsp_aia(asn)
