...
def set_path_len_constraint(tbs, asn):
    new_bc = x509.basic_constraints(True, asn, 1)
...
def main():
    ...
    # Set pathLenConstraint to 1 in the localhost certificate
    set_path_len_constraint(end_tbs, asn)
