...
def remove_key_usage_ext(tbs):
    def not_key_usage(ext):
        return ext['extnID'] != x509.oid_map['keyUsage']
    tbs['extensions'] = list(filter(not_key_usage, tbs['extensions']))
