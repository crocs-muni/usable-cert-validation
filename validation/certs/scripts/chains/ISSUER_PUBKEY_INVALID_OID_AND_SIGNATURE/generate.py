...
def change_pubkey_info_oid(tbs):
    tbs['subjectPublicKeyInfo']['algorithm']['algorithm'] = '1.2.3.4'
...
def main():
    ...
    # change the oid of pubkey algorithm (invalidates the signature)
    change_pubkey_info_oid(sub_tbs)
