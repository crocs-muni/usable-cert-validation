...
EXPORTED_INTERMEDIATE_NAME = 'intermediate.pem'
...
def main():
    ...
    # Write the intermediate into separate file, this is the "trust anchor"
    io.export_cert(sub_cert_der, args.build_dir + EXPORTED_INTERMEDIATE_NAME)
