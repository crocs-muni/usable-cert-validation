...
def make_end_cert_not_yet_valid(end_tbs):
    end_tbs['validity']['notBefore'] = ('generalTime',
                                        misc.current_time_offset(365))
    end_tbs['validity']['notAfter'] = ('generalTime',
                                       misc.current_time_offset(365 * 2))
...
def main():
    ...
    make_end_cert_not_yet_valid(end_tbs)
