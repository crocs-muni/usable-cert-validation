...
def san_ext_with_email(asn):
    return x509.subject_alt_name([('rfc822Name', 'mail@muni.cz')], asn)
...
def main():
    ...
    # Create SAN extension with an email
    san_ext = san_ext_with_email(asn)
