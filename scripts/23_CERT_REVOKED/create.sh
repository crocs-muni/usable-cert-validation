...
certtool --generate-crl --load-ca-certificate files/ca.crt --load-ca-privkey files/ca.key --outfile files/ca.crl --template crl.cfg --load-certificate files/user.crt
