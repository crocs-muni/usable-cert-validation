...
certtool --generate-privkey --outfile files/subsubca.key
certtool --generate-request --load-privkey files/subsubca.key --outfile files/subsubca.csr --template subsubca.cfg
certtool --generate-certificate --load-request files/subsubca.csr --outfile files/subsubca.crt --load-ca-certificate files/subca.crt --load-ca-privkey files/subca.key --template subsubca.cfg
...
certtool --generate-certificate --load-request files/user.csr --outfile files/user.crt --load-ca-certificate files/subsubca.crt --load-ca-privkey files/subsubca.key --template user.cfg
